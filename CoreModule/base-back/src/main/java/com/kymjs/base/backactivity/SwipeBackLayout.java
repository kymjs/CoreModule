...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.baseback_SwipeBackLayout,
                defStyle, R.style.baseback_SwipeBackLayout);

        int edgeSize = a.getDimensionPixelSize(R.styleable.baseback_SwipeBackLayout_baseback_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(R.styleable.baseback_SwipeBackLayout_baseback_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(R.styleable.baseback_SwipeBackLayout_baseback_shadow_left,
                R.drawable.baseback_shadow_left);
        int shadowRight = a.getResourceId(R.styleable.baseback_SwipeBackLayout_baseback_shadow_right,
                R.drawable.baseback_shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.baseback_SwipeBackLayout_baseback_shadow_bottom,
                R.drawable.baseback_shadow_bottom);
